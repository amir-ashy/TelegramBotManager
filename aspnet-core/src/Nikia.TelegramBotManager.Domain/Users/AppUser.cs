...
namespace Nikia.TelegramBotManager.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update TelegramBotManagerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update TelegramBotManagerEfCoreEntityExtensionMappings to extend the IdentityUser entity
