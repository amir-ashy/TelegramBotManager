...
{
    public static class TelegramBotManagerEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE TelegramBotManagerModuleExtensionConfigurator CLASS (in the Domain.Shared project)
