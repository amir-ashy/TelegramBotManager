        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckMembership = table.Column<bool>(type: "boolean", nullable: false),
                    MembershipTargetId = table.Column<string>(type: "text", nullable: true),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsageResultType = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsageLog_BotUser_BotUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsageLog_BotUserId",
                schema: "telegram",
                table: "UsageLog",
                column: "BotUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UsageLog_FileId",
                schema: "telegram",
                table: "UsageLog",
                column: "FileId");
        }
