...
{
    [DbContext(typeof(TelegramBotManagerMigrationsDbContext))]
    partial class TelegramBotManagerMigrationsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nikia.TelegramBotManager.BotManager.Bot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("CheckMembership")
                    ...
                    b.Property<string>("MembershipTargetId")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ServerPathId")
                        .HasColumnType("text");
                    ...
                    b.ToTable("Bot", "telegram");
                });

            modelBuilder.Entity("Nikia.TelegramBotManager.BotManager.BotUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BotUser", "telegram");
                });

            modelBuilder.Entity("Nikia.TelegramBotManager.BotManager.File", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("File", "telegram");
                });

            modelBuilder.Entity("Nikia.TelegramBotManager.BotManager.UsageLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("UsageResultType")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Nikia.TelegramBotManager.BotManager.BotUser", b =>
                {
                    b.HasOne("Nikia.TelegramBotManager.BotManager.Bot", null)
                        .WithMany()
                        .HasForeignKey("BotId")
            ...
            modelBuilder.Entity("Nikia.TelegramBotManager.BotManager.UsageLog", b =>
                {
                    b.HasOne("Nikia.TelegramBotManager.BotManager.BotUser", null)
                        .WithMany()
                        .HasForeignKey("BotUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Nikia.TelegramBotManager.BotManager.File", null)
                        .WithMany()
