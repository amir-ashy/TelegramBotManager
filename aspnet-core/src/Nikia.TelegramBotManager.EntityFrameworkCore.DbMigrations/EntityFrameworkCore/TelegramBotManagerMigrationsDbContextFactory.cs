...
namespace Nikia.TelegramBotManager.EntityFrameworkCore
{
    ...
    public class TelegramBotManagerMigrationsDbContextFactory : IDesignTimeDbContextFactory<TelegramBotManagerMigrationsDbContext>
    {
        ...
        private static IConfigurationRoot BuildConfiguration()
        {
            var builder = new ConfigurationBuilder()
                .SetBasePath(Path.Combine(Directory.GetCurrentDirectory(), "../Nikia.TelegramBotManager.DbMigrator/"))
